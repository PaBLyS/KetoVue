    ...
    <section class="block">
        <b-container>
            ...
            <p class="text">This Privacy Policy governs your use of this Website and any content, products or services
                ...
                to the terms of this Privacy Policy, as they may be amended from time to time. As Company updates or
                expands its Website, services or products, this Privacy Policy may change and the changes are effective
                upon posting. Please check back frequently for updates as it is your sole responsibility to be aware of
            ...
            <p class="text">This Policy describes the information collection, use, and dissemination practices of
                ...
                Websites, (c) on various Third Party websites, and (d) Company's other information collection and
            ...
            <p class="text">Company may collect Personal Information from you when you provide information to a third
                ...
                education and marital status, occupation, industry of employment, personal and online interests, and
                such other information you may have provided to the third party. When acquiring this information,
            ...
            <p class="text">“Cookies” are a feature in your browser software. If enabled, we may write cookies that may
                ...
                to your preferences. We may use cookies to: keep track of the number of return visits to this site;
                accumulate and report aggregate, statistical information on website usage; deliver specific content to
                you based on your interests or past viewing history; save your password for ease of access to our Site.
                You can disable cookies, although the Site may not function properly for you. Your browser preferences
            ...
            <p class="text">Company automatically tracks certain information based upon your behavior on the site. We
                ...
                is on the site or not), your computer browser information, and your IP address. Your Internet Protocol
                ("IP") is a unique Internet "address" which is assigned to you by your Internet Service Provider
                ("ISP"). For local area network ("LAN"), DSL, or cable modem users, an IP address may be permanently
                assigned to a particular computer. IP addresses are automatically logged by Web servers, collecting
                information about a user's traffic patterns. While the IP address does not identify an individual by
                name, it may, with the cooperation of the ISP, be used to locate and identify an individual using the
            ...
            <p class="text">Company may make available a service through which you can receive messages on your wireless
                ...
                the wireless device on which messages will be received, and that you are authorized to approve the
            ...
            <p class="text">Company will use or disclose your Personal Information in response to subpoenas, court
                ...
                its owners, or those of Company's other customers. Finally, we will use or disclose your Personal
                Information if we believe it is necessary to share information in order to investigate, prevent, or take
